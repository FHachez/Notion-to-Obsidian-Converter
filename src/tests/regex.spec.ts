...
import { getApproximateNotionMatches, getLinkFloaterMatches, getLinkTextWithSurroudingBracketMatches, getLinkTextWithPathMatches, getNotionMatches } from '../regex';
...
describe('getApproximateNotionMatches', () => {
	const inputTextToExpectedNotionMatches: [string, string | null, string | null][] = [
		// Normal link to other note
		["let's get a full match [Mental - Pocket (N)](Mental%20Model%20(Master)%209046d23c4cd340f2854d889061e29548/Mental%20Models%20I%20Find%20Repeatedly%20Useful%20-%20Gabriel%20W%20460d555b62aa404eab75b7a3f188e96e.md) follow up",
			null, null],
		// Url link
	...
	it.each(inputTextToExpectedNotionMatches)('should correctly parse "%s"', (input, expectedFullMatch, expectedGroup) => {

		const output = getApproximateNotionMatches(input)
		console.log(output)
